...
export default function Donation() {
  ...
  const [completedDonation, setCompletedDonation] = useState<DonationData | null>(null);
  ...
  const predefinedAmounts = donationService.getPredefinedAmounts();
  ...
  const handleDownloadCertificate = async () => {
    if (completedDonation) {
      try {
        await generateDonationCertificateForData(completedDonation);
      } catch (error) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-2xl font-bold">{donationService.formatAmount(stats.totalAmount)}</p>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-2xl font-bold">{donationService.formatAmount(stats.averageDonation)}</p>
                      ...
                      >
                        {isProcessing ? (
                          ...
                          <>
                            ...
                            <span className="ml-2">
                              Donate {selectedAmount ? donationService.formatAmount(selectedAmount) : "Now"}
                            </span>
                          </>
                        )}
                      </Button>
                ...
                <div className="space-y-6">
                  <div className="text-center space-y-2">
                    <p className="text-2xl font-bold text-primary">
                      {donationService.formatAmount(completedDonation.amount)}
                    </p>
